...
namespace winProyEnlace
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            enlaceComunica.Usuario = "Paolo"; // Asignar el nombre del usuario actual
        ...
        private void btnEnviar_Click(object sender, EventArgs e)
        {
            ...
            Bitmap iconoEnvio = enlaceComunica.Usuario == "Paolo" ? usuario1Icono : usuario2Icono;
        ...
        private void enlaceComunica_LlegoMensaje(string n)
        {
            ...
            {
                Bitmap iconoRecibido = enlaceComunica.Usuario == "Paolo" ? usuario2Icono : usuario1Icono;
                string usuarioRemitente = enlaceComunica.Usuario == "Paolo" ? "Mario" : "Paolo";
